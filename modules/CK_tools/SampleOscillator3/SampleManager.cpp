...
//GetEdit and TestOn added, lines 174 to 191
...
int SampleManager::GeditOn( int Ged )
{
    on=Ged;
    return on;
}
/*int SampleManager::MemHandle( int sampleHandle )
{
    mem=sampleHandle;
    return mem;
}*/
int SampleManager::TestOn()
{
    return on;
}
/*int SampleManager::TestHandle()
{
    return mem;
}*/
